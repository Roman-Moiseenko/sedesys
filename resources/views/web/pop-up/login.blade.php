...
>
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="login-form" class="p-3 needs-validation" action="{{ route('web.login') }}" method="post" role="form" novalidate>
                @csrf
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-floating my-3">
                            ...
                            <label for="verify_token">Код подтверждения ({{$web->auth_phone ? 'с СМС' : 'с почты'}})</label>
                            <span id="token-error" class="fs-7 text-danger" style="display: none">Неверный код подтверждения</span>
                        </div>
                        <div class="fs-7 mt-3">
                            @if($web->auth_phone)
                                <a id="new-password" href="#" data-route="{{ route('web.password.phone') }}">Забыли пароль?</a>
                                <div id="new-password-button" class="d-flex justify-content-center my-1" >
                                    <button id="new-password-send" type="button" class="btn btn-outline-dark fs-5 py-1 px-2" style="display: none;">
