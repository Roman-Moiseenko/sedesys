        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <router-link
                        :to="{name: 'Show Product', params: {id: scope.row.id}}"
...
<script>
    ...
    import {PRODUCT_FETCH, PRODUCT_OBTAIN} from '../store/types'
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['products', 'productsMeta', 'productsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([PRODUCT_FETCH]),
            ...mapMutations([PRODUCT_OBTAIN]),
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the product. Continue?', 'Warning', {
                    ...
                    productApi.delete(row.id).then((response) => {
                        this.$message({
