                    ...
                    <div class="grid lg:grid-cols-3 grid-cols-1 divide-x">
                        <div class="p-4">
                            ...
                            <el-form-item label="Цена">
                                <el-input v-model="form.price" placeholder="В рублях"
                            ...
                            <el-form-item label="Длительность">
                                <el-input v-model="form.duration" placeholder="В минутах"
                                          :formatter="(val) => func.MaskInteger(val)">
...
function onSubmit(val) {
    form.close = val
    router.visit(route('admin.service.service.update', {service: props.service.id}), {
        method: 'post',
        data: form,
        preserveScroll: true,
        preserveState: true,
