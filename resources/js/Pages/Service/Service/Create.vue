                    ...
                    <div class="grid lg:grid-cols-3 grid-cols-1 divide-x">
                        <div class="p-4">
                            <el-form-item label="Классификация">
                                ...
                                <div v-if="errors.classification_id" class="text-red-700">{{
                            ...
                            <el-form-item label="Цена">
                                <el-input v-model="form.price" placeholder="В рублях" :formatter="(val) => func.MaskInteger(val)">
                                    <template #append>₽</template>
                                </el-input>
                                <div v-if="errors.price" class="text-red-700">{{ errors.price }}</div>
                            </el-form-item>
                            <el-form-item label="Длительность">
                                <el-input v-model="form.duration" placeholder="В минутах" :formatter="(val) => func.MaskInteger(val)">
                        ...
                        <div class="p-4">
                            <el-form-item label="Опции">
                                <el-input v-model="form.data" placeholder="В формате JSON [{}]" :rows="5"
                                          type="textarea"/>
...
function onSubmit() {
    router.post(route('admin.service.service.store'), form)
}
