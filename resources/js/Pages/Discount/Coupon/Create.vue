            ...
            <div class="grid lg:grid-cols-3 grid-cols-1 divide-x">
                ...
                <div class="p-4">
                    <div class="p-3 rounded-lg bg-sky-100 border border-sky-600">
                        ...
                        <div class="text-sm">Все параметры условий работают как <strong>ИЛИ</strong>. Т.е. если клиент соответствует одному из условий, он получает купон.</div>
                        ...
                        <div class="text-sm">Если не указать дату окончания, купон будет бессрочный</div>
                    </div>
                </div>
            </div>
