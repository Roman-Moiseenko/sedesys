...
return [
    ...
    |
    */
    'default' => env('IMAP_DEFAULT_ACCOUNT', 'google'),
    ...
    'accounts' => [
      ...
      /*  'default' => [// account identifier
        ...
        'sedesys' => [ // account identifier
            ...
            'validate_cert' => true,
            'username' => env('IMAP_USERNAME', 'root@example.com'),
            'password' => env('IMAP_PASSWORD', ''), //'@12244DDDddd',
            'authentication' => 'OAuth2',
        ],
        'mailru' => [ // account identifier
            'host' => 'imap.mail.ru',
            'port' => 993,
            'encryption' => 'ssl',
            'validate_cert' => true,
            'username' => '******@mail.ru',
            'password' => 'Спец.пароль для сторонних приложений',
            'authentication' => 'OAuth2',
        ],
