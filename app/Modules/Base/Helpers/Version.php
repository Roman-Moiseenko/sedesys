    ...
    public static function updates(): array
    {
        return [
            ...
            '0.2. Идет разработка ....' => [
                ...
                '... разрабатывается ...',
                'Модуль Уведомления - ',
                ' - Уведомления email, telegram, whatsapp, database, vk, google-calendar',
                'Почта - отправка и получение',
                'Настройка уведомления для разных типов пользователей',
                'Авторизация пользователей через VK, Google и др.'
            ],
            '0.1. Базовая версия' => [
